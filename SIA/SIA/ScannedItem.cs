...
namespace SIA
{
    public class ScannedItem : INotifyPropertyChanged
    {
        ...
        public async Task<string> PostOutputCSV(string barcode, string fname, string lotNo, string DPRID, string JORNO, int last = 0)
        {
            //used for output posting to CSV            
            //http://172.11.66.181/xampp/siasaveoutputCSV.php?barcode=25 250      PC 3611420  &fname=mstId.Text&lotno=i.lotNumber&DPRID=lblDPRid.text&jorno=lblJORNo.Text
            try
            {
                var Url = "";
                if (last == 0)
                {
                    Url = "http://172.11.66.181/xampp/siasaveoutputCSV.php?barcode=" + barcode + "&fname=" + fname + "&lotno=" + lotNo + "&DPRID=" + DPRID + "&jorno="+ JORNO;
                }
                else
                {
                    Url = "http://172.11.66.181/xampp/siasaveoutputCSV.php?barcode=" + barcode + "&fname=" + fname + "&lotno=" + lotNo + "&DPRID=" + DPRID + "&jorno=" + JORNO + "&last=1";
                }
